...
namespace SpanishWebProj.Migrations
{
    ...
    [Migration("20240319174212_WorksheetsAndCategory")]
    partial class WorksheetsAndCategory
    {
            ...
            modelBuilder.Entity("Domain.Entity.Worksheet.Worksheet", b =>
                {
                    ...
                    b.Property<int>("IdWorksheetCategory")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("IdWorksheetCategory");
            ...
            modelBuilder.Entity("Domain.Entity.Worksheet.Worksheet", b =>
                {
                    b.HasOne("Domain.Entity.Worksheet.WorksheetCategory", "WorksheetCategory")
                        .WithMany("Worksheets")
                        .HasForeignKey("IsWorksheetCategory")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
