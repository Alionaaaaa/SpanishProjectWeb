            ...
            modelBuilder.Entity("Domain.Entity.Forum.ForumMessage", b =>
                {
                    ...
                    b.HasOne("Domain.Entity.Profile", "Profile")
                        .WithOne("ForumMessage")
                        .HasForeignKey("Domain.Entity.Forum.ForumMessage", "ProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entity.User", "User")
                        .WithOne("ForumMessage")
                        .HasForeignKey("Domain.Entity.Forum.ForumMessage", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
